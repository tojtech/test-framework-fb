...
[locally installed Chrome browser](https://www.seleniumhq.org/docs/03_webdriver.jsp#introducing-the-selenium-webdriver-api-by-facebook).
...
1. If browser doesn't start:
    ...
    1. Check if Glue is set to _com.facebook_ in _Run/Debug Configurations > Templates > Cucumber java > Glue_ line 
